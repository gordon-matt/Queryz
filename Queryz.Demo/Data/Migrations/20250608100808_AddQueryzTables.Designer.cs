...
namespace Queryz.Demo.Data.Migrations
{
    ...
    [Migration("20250608100808_AddQueryzTables")]
    partial class AddQueryzTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Queryz.Demo.Data.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Queryz.Demo.Data.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ApplicationRoleApplicationUser", b =>
                {
                    b.HasOne("Queryz.Demo.Data.Entities.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Queryz.Demo.Data.Entities.ApplicationUser", null)
                        .WithMany()
