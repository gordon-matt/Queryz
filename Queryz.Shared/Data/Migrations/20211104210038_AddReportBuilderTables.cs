...
public partial class AddReportBuilderTables : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Queryz_DataSources", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Queryz_Enumerations", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Queryz_ReportGroups", x => x.Id));
